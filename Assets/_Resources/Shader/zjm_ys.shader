...
////// Emissive:
                ...
                float4 node_4636 = _Time + _TimeEditor;
                float2 node_9352 = (i.uv0+node_4636.g*float2(-0.01,-0.01));
                float4 _node_8500_var = tex2D(_node_8500,TRANSFORM_TEX(node_9352, _node_8500));
                float2 node_3798 = (i.uv0+node_4636.g*float2(-0.03,-0.03));
