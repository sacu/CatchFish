...
////// Emissive:
                ...
                float4 node_9195 = _Time + _TimeEditor;
                float2 node_9352 = (i.uv0+node_9195.g*float2(0.01,-0.01));
                float4 _node_8500_var = tex2D(_node_8500,TRANSFORM_TEX(node_9352, _node_8500));
                float2 node_3798 = (i.uv0+node_9195.g*float2(0.03,-0.03));
                float4 _wenli_var = tex2D(_wenli,TRANSFORM_TEX(node_3798, _wenli));
                float3 node_8970 = ((((1.5*_mask_bian_var.a)*pow(_guangtiao_var.r,1.3))+(pow(_guangtiao_var.r,2.0)*(_mask_var.a*(_node_8500_var.r+_wenli_var.r))*0.5))*float3(1,1.5,2.3));
                float3 emissive = node_8970;
