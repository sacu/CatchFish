...
Shader "Shader Forge/Examples/LightWrapping" {
    Properties {
        ...
        _Gloss_copy ("Gloss_copy", Range(0, 1)) = 0.895261
        _Gloss_copy_copy ("Gloss_copy_copy", Range(0, 1)) = 0.895261
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma exclude_renderers gles2 xbox360 ps3 
            #pragma target 2.0
...
////// Specular:
                ...
                diffuseColor = DiffuseAndSpecularFromMetallic( diffuseColor, 2.0, specularColor, specularMonochrome );
...
/// Final Color:
                ...
                return fixed4(finalColor,_Gloss_copy);
            }
            ENDCG
        }
        Pass {
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                return fixed4(finalColor * _Gloss_copy,0);
            }
            ENDCG
        }
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float specularMonochrome;
                float3 specColor;
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, 2.0, specColor, specularMonochrome );
