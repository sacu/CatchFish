...
namespace SA.Core
{
    ...
    [System.Serializable]
    public abstract class SA3MeshCombiner
    {
        ...
        [SerializeField]
        protected SA2LogLevel _LOG_LEVEL = SA2LogLevel.info;
        public virtual SA2LogLevel LOG_LEVEL
        {
        ...
        [SerializeField]
        protected SA2ValidationLevel _validationLevel = SA2ValidationLevel.robust;
        public virtual SA2ValidationLevel validationLevel
        {
        ...
        public virtual SA2TextureCombineResults textureBakeResults
        {
        ...
        [SerializeField]
        protected SARenderType _renderType;
        public virtual SARenderType renderType
        {
        ...
        [SerializeField]
        protected SA2OutputOptions _outputOption;
        public virtual SA2OutputOptions outputOption
        {
        ...
        [SerializeField]
        protected SA2LightmapOptions _lightmapOption = SA2LightmapOptions.ignore_UV2;
        public virtual SA2LightmapOptions lightmapOption
        {
        ...
        {
            return _lightmapOption == SA2LightmapOptions.copy_UV2_unchanged || _lightmapOption == SA2LightmapOptions.preserve_current_lightmapping;
        }
        ...
        public static void UpdateSkinnedMeshApproximateBoundsFromBoundsStatic(List<GameObject> objectsInCombined, SkinnedMeshRenderer smr)
        {
            ...
            if (SAUtility.GetBounds(objectsInCombined[0], out b))
            {
                bigB = b;
            }
            else
            ...
            {
                if (SAUtility.GetBounds(objectsInCombined[i], out b))
                {
                    bigB.Encapsulate(b);
                }
                else
