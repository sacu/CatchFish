...
using SA.Core;
public abstract class SA3MeshCombineCommon : SA3MeshCombineRoot
{
    //todo should be list of <Renderer>
    public List<GameObject> objsToMesh;

    public abstract SA3MeshCombiner meshCombiner
    {
        get;
    }
    ...
    public override List<GameObject> GetObjectsToCombine()
    {
        if (useObjsToMeshFromTexBaker)
        {
            ...
            if (tb == null) tb = gameObject.transform.parent.GetComponent<SA3TextureCombine>();
            if (tb != null)
            {
    ...
    public virtual void DestroyMeshEditor(SA2EditorMethodsInterface editorMethods)
    {
    ...
    public SA3TextureCombine GetTextureBaker()
    {
        ...
        if (transform.parent != null) return transform.parent.GetComponent<SA3TextureCombine>();
        return null;
    }
    ...
    /// </summary>	
    public virtual void Apply(SA3MeshCombiner.GenerateUV2Delegate uv2GenerationMethod = null)
    {
    ...
    {
        if (meshCombiner.outputOption == SA2OutputOptions.bakeMeshAssetsInPlace)
        {
